...
//         console.log("Created Payment Entry:", paymentDetails);
...
//                 purchase_order_name: booking.venueName,  // Venue name as product name
//                 customer_info: {
...
//         console.log("Khalti Payment Initiation Response:", {
//             pidx,
//             payment_url,
//         });

//         console.log("Updating the Payment entry with the PIDX...");

//         // Update the Payment entry with the pidx
//         paymentDetails.gatewayReference = pidx;
//         await paymentDetails.save();

//         console.log("Updated Payment Entry with PIDX:", paymentDetails);

//         console.log("Khalti payment initiation completed successfully.");
...
const initiateKhaltiPayment = async (req, res) => {
    ...
    //   console.log("BOOKING VENUE NAME", booking.venueName);
